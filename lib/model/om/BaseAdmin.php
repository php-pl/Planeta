...
abstract class BaseAdmin extends BaseObject  implements Persistent {
	...
	public function setMid($v)
	{
		...
		if ($this->mid !== $v) {
			$this->mid = $v;
			$this->modifiedColumns[] = AdminPeer::MID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 2; // 2 = AdminPeer::NUM_COLUMNS - AdminPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setMid($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AdminPeer::MID)) $criteria->add(AdminPeer::MID, $this->mid);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AdminPeer::MID, $this->mid);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setMid(NULL); // this is a pkey column, so set to default value

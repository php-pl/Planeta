...
/**
 * Base static class for performing query and update operations on the 'post_tag' table.
 *
 * 
 *
...
abstract class BasePostTagPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'PostId', 'TagId', ),
		BasePeer::TYPE_COLNAME => array (PostTagPeer::ID, PostTagPeer::POST_ID, PostTagPeer::TAG_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'post_id', 'tag_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PostId' => 1, 'TagId' => 2, ),
		BasePeer::TYPE_COLNAME => array (PostTagPeer::ID => 0, PostTagPeer::POST_ID => 1, PostTagPeer::TAG_ID => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'post_id' => 1, 'tag_id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		include_once 'lib/model/map/PostTagMapBuilder.php';
	 ...
	 * @param      string $column The column name for current table. (i.e. PostTagPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	/**
	 * Selects a collection of PostTag objects pre-filled with their Post objects.
	 *
	...
	public static function doSelectJoinPost(Criteria $c, $con = null)
	{
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getPost(); //CHECKME
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					// e.g. $author->addBookRelatedByBookId()
					$temp_obj2->addPostTag($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initPostTags();
				$obj2->addPostTag($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	/**
	 * Selects a collection of PostTag objects pre-filled with their Tag objects.
	 *
	 * @return     array Array of PostTag objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	/**
	 * Selects a collection of PostTag objects pre-filled with all related objects.
	 *
	 * @return     array Array of PostTag objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj3 = $temp_obj1->getTag(); // CHECKME
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addPostTag($obj1); // CHECKME
					break;
				}
			}
	...
	/**
	 * Selects a collection of PostTag objects pre-filled with all related objects except Post.
	 *
	 * @return     array Array of PostTag objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	/**
	 * Method perform an INSERT on the database, given a PostTag or Criteria object.
	 *
	 * @param      mixed $values Criteria or PostTag object containing data that is used to create the INSERT statement.
	 * @param      Connection $con the connection to use
	...
	public static function doInsert($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from PostTag object
		}

		$criteria->remove(PostTagPeer::ID); // remove pkey col since this table uses auto-increment
	...
	/**
	 * Method perform an UPDATE on the database, given a PostTag or Criteria object.
	 *
	 * @param      mixed $values Criteria or PostTag object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the post_tag table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a PostTag or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or PostTag object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} elseif ($values instanceof PostTag) {
	...
	/**
	 * Validates all modified columns of given PostTag object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      PostTag $obj The object to validate.
...
if (Propel::isInit()) {
	...
	require_once 'lib/model/map/PostTagMapBuilder.php';

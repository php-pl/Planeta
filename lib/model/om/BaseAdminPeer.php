...
abstract class BaseAdminPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Mid', 'Email', ),
		BasePeer::TYPE_COLNAME => array (AdminPeer::MID, AdminPeer::EMAIL, ),
		BasePeer::TYPE_FIELDNAME => array ('mid', 'email', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Mid' => 0, 'Email' => 1, ),
		BasePeer::TYPE_COLNAME => array (AdminPeer::MID => 0, AdminPeer::EMAIL => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('mid' => 0, 'email' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AdminPeer::MID);

		$criteria->addSelectColumn(AdminPeer::EMAIL);

	}

	const COUNT = 'COUNT(admin.MID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT admin.MID)';
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(AdminPeer::MID);
			$selectCriteria->add(AdminPeer::MID, $criteria->remove(AdminPeer::MID), $comparison);
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(AdminPeer::MID, (array) $values, Criteria::IN);
		}

...
class sfFeedItem
{
  ...
  public function getDescription ()
  {
    ...
    else if($this->content)
    {
      ...
      $description_max_length = sfConfig::get('app_feed_item_max_length', 120);
      if (strlen($description) > $description_max_length)
      {
        $description = utf8_substr($description, 0, $description_max_length - strlen($description)).'[...]';
      }
      return $description;
    }
  }
...
function utf8_substr($str, $start, $end = null) {
